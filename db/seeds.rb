...
Printed errors = Challenge.new(
  ...
  You have to write a function printer_error which given a string will return the error rate of the printer as a string representing a rational whose numerator is the number of errors and the denominator the length of the control string. Do not reduce this fraction to a simpler expression.
...
Matrix Multiplier = Challenge.new(
  name: 'Matrix Multiplier',
  description: 'In mathematics, a matrix (plural matrices) is a rectangular array of numbers. Matrices have many applications in programming, from performing transformations in 2D space to machine learning.
...
Descending order = Challenge.new(
